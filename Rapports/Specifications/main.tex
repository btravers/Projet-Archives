...
\subsubsection{Fonction SB04 - Naviguer entre deux registres adjacents}
...
\begin{table}[H]
  \centering
   \small
	\begin{tabular}{|c|p{12cm}|}
   		\hline
   			\rowcolor{lightgray}\multicolumn{2}{|c|}{\textbf{SB04 - Naviguer entre deux registres adjacents}} \\
   		\hline
   			\multicolumn{2}{|l|}{Condition de d\'eclenchement} \\
   		\hline
  		...
  		\hline
   		...
   		\hline
	\end{tabular}
  \caption{SB04 - Naviguer entre deux registres}
  \normalsize
  \label{tab:naviguer_deux_registres_adjacents}
\end{table}

\subsubsection{Fonction SB05 - Naviguer entre deux registres numérotés}
...
\begin{table}[H]
  ...
  \begin{tabular}{|c|p{12cm}|}
      \hline
        \rowcolor{lightgray}\multicolumn{2}{|c|}{\textbf{SB05 - Naviguer entre deux registres numérotés}} \\
      \hline
        \multicolumn{2}{|l|}{Condition de d\'eclenchement} \\
      \hline
      ...
      \hline
  \end{tabular}
  \caption{SB05 - Naviguer entre deux registres numérotés}
  \normalsize
...
\subsubsection{Fonction SB06 - Naviguer d'une table à un registre inconnu}
...
\begin{table}[H]
  \centering
   \small
	\begin{tabular}{|c|p{12cm}|}
   		\hline
   			\rowcolor{lightgray}\multicolumn{2}{|c|}{\textbf{SB06 - Naviguer d'une table à un registre inconnu}} \\
   		\hline
   			\multicolumn{2}{|l|}{Condition de d\'eclenchement} \\
   		\hline
  		...
  		\hline
   		...
   		\hline
	\end{tabular}
  \caption{SB06 - Naviguer d'une table à un registre inconnu}
  \normalsize
...
\subsubsection{Fonction SB07 - Naviguer d'une table à un registre connu}
...
\begin{table}[H]
  ...
  \begin{tabular}{|c|p{12cm}|}
      \hline
        \rowcolor{lightgray}\multicolumn{2}{|c|}{\textbf{SB07 - Naviguer d'une table à un registre connu}} \\
      \hline
        \multicolumn{2}{|l|}{Condition de d\'eclenchement} \\
      \hline
      -1 & Un utilisateur veut acc\'eder \`a un registre à partir d'une table. \\
      ...
      \hline
  \end{tabular}
  \caption{SB07 - Naviguer d'une table à un registre connu}
  \normalsize
...
\subsubsection{Fonction SC02 - Annoter un registre}
...
\begin{table}[H]
  \centering
   \small
	\begin{tabular}{|c|p{12cm}|}
   		\hline
   			\rowcolor{lightgray}\multicolumn{2}{|c|}{\textbf{SC02 - Annoter un registre}} \\
   		\hline
   			\multicolumn{2}{|l|}{Condition de d\'eclenchement} \\
   		\hline
  		...
  		\hline
   		...
   		\hline
	\end{tabular}
  \caption{SC02 - Annoter un registre}
  \normalsize
  \label{tab:annoter_registre}
\end{table}

\subsubsection{Fonction SC03 - Annotation libre sur registres}
...
\begin{table}[H]
  \centering
   \small
	\begin{tabular}{|c|p{12cm}|}
   		\hline
   			\rowcolor{lightgray}\multicolumn{2}{|c|}{\textbf{SC03 - Annotation libre sur registres}} \\
   		\hline
   			\multicolumn{2}{|l|}{Condition de d\'eclenchement} \\
   		\hline
