...
Développer sur ce type de plateforme va donner une image neuve des archives, les surfaces tactiles sont extrêmement à la mode. De plus, travailler sur cette plateforme va nous apprendre des technologies nouvelles.
...
L'application devra être fonctionnelle sur une base de données Oracle qui est utilisée par les Archives, mais non disponible lors du développement du projet. MySQL sera donc utilisé, il sera important de garder une compatibilité pour pouvoir transférer la version final de l'application sur un serveur Oracle. Il s'agit d'éviter d'utiliser des fonctions qui ne marche que sur MySQL pour faciliter le transfert.
...
\begin{figure}[H]
\centering
\includegraphics[width=4cm,height=9cm]{ajouterraccourci.png}
