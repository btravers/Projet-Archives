...
\subsubsection{Fonction SC01 - Naviguer dans une m\^eme table jusqu'à une page adjacente}
...
\subsubsection{Fonction SC02 - Naviguer dans une m\^eme table jusqu'à une page numérotée}
...
\subsubsection{Fonction SC04 - Naviguer entre deux registres adjacents}
...
\subsubsection{Fonction SC05 - Naviguer entre deux registres numérotés}
...
\subsubsection{Fonction SC06 - Naviguer d'une table à un registre inconnu}
...
\subsubsection{Fonction SC07 - Naviguer d'une table à un registre connu}
...
\subsubsection{Fonction SF01 - Marquer un document}
...
\begin{table}[H]
  \centering
   \small
	\begin{tabular}{|c|p{12cm}|}
   		\hline
   			\rowcolor{lightgray}\multicolumn{2}{|c|}{\textbf{SD06 - Marquer un document}} \\
   		\hline
   			\multicolumn{2}{|l|}{Condition de d\'eclenchement} \\
   		\hline
  		...
  		\hline
   		...
   		\hline
	\end{tabular}
  \caption{SD06 - Marquer un document}
  \normalsize
  \label{tab:marquer_document}
\end{table}

\subsubsection{Fonction SF04 - Créer un dossier}
...
\begin{table}[H]
  \centering
   \small
	\begin{tabular}{|c|p{12cm}|}
   		\hline
   			\rowcolor{lightgray}\multicolumn{2}{|c|}{\textbf{SD06 - Créer un dossier}} \\
   		\hline
   			\multicolumn{2}{|l|}{Condition de d\'eclenchement} \\
   		\hline
  		...
  		\hline
   		...
   		\hline
	\end{tabular}
  \caption{SD06 - Créer un dossier}
  \normalsize
  \label{tab:creer_document}
\end{table}

\subsubsection{Fonction SF04 - Renommer un document}
...
\begin{table}[H]
  \centering
   \small
	\begin{tabular}{|c|p{12cm}|}
   		\hline
   			\rowcolor{lightgray}\multicolumn{2}{|c|}{\textbf{SD06 - Renommer un document}} \\
   		\hline
   			\multicolumn{2}{|l|}{Condition de d\'eclenchement} \\
   		\hline
  		...
  		\hline
   		...
   		\hline
	\end{tabular}
  \caption{SD06 - Renommer un document}
  \normalsize
  \label{tab:renommer_document}
\end{table}

\subsubsection{Fonction SF06 - Déplacer un document dans un dossier}
...
\subsubsection{Fonction SF05 - Supprimer un document}
...
\begin{table}[H]
  \centering
   \small
	\begin{tabular}{|c|p{12cm}|}
   		\hline
   			\rowcolor{lightgray}\multicolumn{2}{|c|}{\textbf{SD06 - Supprimer un document}} \\
   		\hline
   			\multicolumn{2}{|l|}{Condition de d\'eclenchement} \\
   		\hline
		...
		\hline
   		...
   		\hline
	\end{tabular}
  \caption{SD06 - Supprimer un document}
  \normalsize
